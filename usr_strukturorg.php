  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container">
        ...
        <br><br><br>
          <h3>Struktur Organisasi - Politeknik Akbara</h3>
          <br>
        </header>
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <p><b>Kepala Rektor</b></p>

            <div class="icon-box wow fadeInUp">
              <div class="icon"><i class="fa fa-user"></i></div>
              <h4 class="title"><a href="">Kepala Rektor</a></h4>
              <p class="description">X</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-user"></i></div>
              <h4 class="title"><a href="">Waka Rektor</a></h4>
              <p class="description">1. x <br> 2. x</p>
            </div>
          
            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-user"></i></div>
              <h4 class="title"><a href="">Waka X</a></h4>
              <p class="description">1.	x <br> 2.	X</p>
            </div>
          </div>
          <div class="col-lg-6 content order-lg-1 order-2">
         ...
         <div class="col-lg-6 content order-lg-1 order-2">
            ...
            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-user"></i></div>
              <h4 class="title"><a href="">Ketua Jurusan</a></h4>
              <p class="description">1.	X <br> 2. X</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-user"></i></div>
              <h4 class="title"><a href="">Kaprodi</a></h4>
              <p class="description">1.	X <br> 2. X</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-user"></i></div>
              <h4 class="title"><a href="">Dosen PA</a></h4>
              <p class="description">1.	X <br> 2. X</p>
            </div>
